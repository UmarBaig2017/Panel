      ...
      <div>
        <Container fluid className="main-content-container px-4">
          <Row noGutters className="page-header py-4">
            <PageTitle title="Student Profile" md="12" className="ml-sm-auto mr-sm-auto" />
          </Row>
          <Row>
            {/*User Profile Showed */}
            <Col lg="4">
                      ...
                      <Col>
                        <Form>
                          ...
                          <Row form>
                            {/* City */}
                            <Col md="6" className="form-group">
                              <label htmlFor="feExam">Subject</label>
                              <FormSelect id="feInputState">
                            ...
                            {/* State */}
                            <Col md="6" className="form-group">
                              <label htmlFor="feLastName">Region</label>
                              <FormInput
                                id="feLastName"
                                placeholder=""
                          ...
                          <Row>
                            ...
                            <Col md="6" className="form-group">
                              <label htmlFor="feExam">Current Studying at</label>
                              <FormSelect id="feInputState">
                          ...
                          <Button theme="success">Update Account</Button>
                        </Form>
                      </Col>
                    </Row>
                  </ListGroupItem>
