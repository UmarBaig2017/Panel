...
async  getuserDetails(uid) {
    ...
    await fetch("http://localhost:5000/api/getUserData"+uid,
    {
      method: "GET",
      headers: {
    ...
    .then(data => {
      ...
      if (data.message === "Success" && data.doc.userType===false) {
        localStorage.setItem('CurrentUser', JSON.stringify(data.doc))
        alert("User LogedIn")
